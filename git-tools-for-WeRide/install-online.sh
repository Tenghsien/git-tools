...
show_completion() {
    ...
    echo ""
    echo "🚀 使用命令："
    echo "   ./git-tools-from-tengxian/git-tools.sh check   - 检查 diff 状态"
    echo "   ./git-tools-from-tengxian/git-tools.sh patch   - 应用未合入的 diff"
    echo "   ./git-tools-from-tengxian/git-tools.sh reset   - 重置到远程分支"
    echo ""
    echo "💡 建议：创建别名"
